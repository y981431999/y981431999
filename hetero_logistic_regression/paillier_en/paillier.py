...
from paillier_en import gmpy_math
from paillier_en.fixedpoint import FixedPointNumber
import numpy as np
...
class PaillierPublicKey(object):
    ...
    def encrypt_list(self, value, precision=None, random_value=None):
        re = []
        for i in value:
            re.append(self.encrypt(i))
        return np.array(re)
